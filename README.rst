...
PaleOrdia modifies the tool Ordia (https://ordia.toolforge.org/) to be represented as a static web application and extends it with options to view paleographic data saved in Wikidata.

While the tool was modified with languages written in the cuneiform script as a focus, its codebase has been written language-agnostic.
...
References
----------
Homburg, Timo. "PaleOrdia: Semantically Describing (Cuneiform) Paleography using Paleographic Linked Open Data." Proceedings of the 1st International Workshop of Semantic Digital Humanities (SemDH 2024) co-located with the European Semantic Web Conference. Vol. 2024. 2024.
